...
public class LayoutConverter {
    ...
    public static String getReplacedText(CharSequence textToReplace, Language fromLanguage, List<CorrectionItem> corrections) {
        ...
        String textToReplaceStr = textToReplace.toString();
        ReplacerService.log(textToReplaceStr + "; lang=" + fromLanguage);

        switch (fromLanguage) {
            case En: {
                textToReplaceStr = textToReplaceStr.replaceAll("\\$\\$", "Á");
                textToReplaceStr = textToReplaceStr.replaceAll("(?i)ll", "Ç");
                textToReplaceStr = textToReplaceStr.replaceAll("(?i)oo", "È");
                textToReplaceStr = textToReplaceStr.replaceAll("(?i)pp", "Ñ");
                textToReplaceStr = textToReplaceStr.replaceAll("(?i)mm", "Ò");
                textToReplaceStr = textToReplaceStr.replaceAll("(?i)qq", "Ž");

                for (int i = 0; i < textToReplaceStr.length(); i++) {
                    if (charsMapEnRu.containsKey(textToReplaceStr.charAt(i))) {
                        text.append(charsMapEnRu.get(textToReplaceStr.charAt(i)));
                    } else {
                        text.append(textToReplaceStr.charAt(i));
                    }
                }
                break;
            }
            case Ru: {
                ...
                for (int i = 0; i < textToReplaceStr.length(); i++) {
                    if (charsMapRuEn.containsKey(textToReplaceStr.charAt(i))) {
                        text.append(charsMapRuEn.get(textToReplaceStr.charAt(i)));
                    } else {
                        text.append(textToReplaceStr.charAt(i));
                    }
                }
            ...
            case RuTrans: {
                //Log.d(LOG_TAG, textToReplace.toString());
                for (int i = 0; i < textToReplaceStr.length(); i++) {
                    if (charsMapRuTransEn.containsKey(textToReplaceStr.charAt(i))) {
                        text.append(charsMapRuTransEn.get(textToReplaceStr.charAt(i)));
                    } else {
                        text.append(textToReplaceStr.charAt(i));
                    }
                }
            ...
            case EnTrans: {
                //Log.d(LOG_TAG, textToReplace.toString());
                textToReplaceStr = textToReplaceStr.replaceAll("(?i)ww", "Ç");
                textToReplaceStr = textToReplaceStr.replaceAll("(?i)ee", "È");
                textToReplaceStr = textToReplaceStr.replaceAll("(?i)uu", "Ñ");
                textToReplaceStr = textToReplaceStr.replaceAll("(?i)zz", "Ò");

                for (int i = 0; i < textToReplaceStr.length(); i++) {
                    if (charsMapEnRuTrans.containsKey(textToReplaceStr.charAt(i))) {
                        text.append(charsMapEnRuTrans.get(textToReplaceStr.charAt(i)));
                    } else {
                        text.append(textToReplaceStr.charAt(i));
                    }
                }
            ...
            case RuFull: {
                //Log.d(LOG_TAG, textToReplace.toString());
                for (int i = 0; i < textToReplaceStr.length(); i++) {
                    if (charsMapRuFullEn.containsKey(textToReplaceStr.charAt(i))) {
                        text.append(charsMapRuFullEn.get(textToReplaceStr.charAt(i)));
                    } else {
                        text.append(textToReplaceStr.charAt(i));
                    }
                }
            ...
            case EnFull: {
                //Log.d(LOG_TAG, textToReplace.toString());
                for (int i = 0; i < textToReplaceStr.length(); i++) {
                    if (charsMapEnRuFull.containsKey(textToReplaceStr.charAt(i))) {
                        text.append(charsMapEnRuFull.get(textToReplaceStr.charAt(i)));
                    } else {
                        text.append(textToReplaceStr.charAt(i));
                    }
                }
            ...
            case EnQwertz: {
                ...
                for (int i = 0; i < textToReplaceStr.length(); i++) {
                    if (charsMapEnRuQwertz.containsKey(textToReplaceStr.charAt(i))) {
                        text.append(charsMapEnRuQwertz.get(textToReplaceStr.charAt(i)));
                    } else {
                        text.append(textToReplaceStr.charAt(i));
                    }
                }
            ...
            case RuQwertz: {
                //Log.d(LOG_TAG, textToReplace.toString());
                for (int i = 0; i < textToReplaceStr.length(); i++) {
                    if (charsMapRuQwertzEn.containsKey(textToReplaceStr.charAt(i))) {
                        text.append(charsMapRuQwertzEn.get(textToReplaceStr.charAt(i)));
                    } else {
                        text.append(textToReplaceStr.charAt(i));
                    }
                }
            ...
            case RuFxtecPro1: {
                //Log.d(LOG_TAG, textToReplace.toString());
                for (int i = 0; i < textToReplaceStr.length(); i++) {
                    if (charsMapRuFxtecPro1En.containsKey(textToReplaceStr.charAt(i))) {
                        text.append(charsMapRuFxtecPro1En.get(textToReplaceStr.charAt(i)));
                    } else {
                        text.append(textToReplaceStr.charAt(i));
                    }
                }
            ...
            case EnFxtecPro1: {
                //Log.d(LOG_TAG, textToReplace.toString());
                for (int i = 0; i < textToReplaceStr.length(); i++) {
                    if (charsMapEnRuFxtecPro1.containsKey(textToReplaceStr.charAt(i))) {
                        text.append(charsMapEnRuFxtecPro1.get(textToReplaceStr.charAt(i)));
                    } else {
                        text.append(textToReplaceStr.charAt(i));
                    }
                }
            ...
            default: {
                ...
                text = new StringBuilder(textToReplaceStr);
                break;
            }
        }
    ...
    public static boolean isNeedDoubleCapitalCorrection(CharSequence textToCorrect) {
        ...
        Log.d(LOG_TAG, "Needs correct double capital: " + isNeedsCorrection + "; " + textToCorrect);
