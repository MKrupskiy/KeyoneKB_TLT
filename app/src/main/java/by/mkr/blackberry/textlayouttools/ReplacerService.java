...
public class ReplacerService {
    ...
    public ReplacerService(Context context) {
        _context = context;
    ...
    public void addToTempDictionary(final String replacedText, final String untranslatedText) {
    ...
    private static @NotNull String getString(int resId) {
